...
func (p *Profile) Handle(params user.ProfileParams, principal interface{}) middleware.Responder {
	...
	return user.NewProfileOK().WithPayload(&models.Profile{Email: userInfo.Email, FirstName: userInfo.FirstName, LastName: userInfo.LastName,MiddleName: userInfo.MiddleName, Username: userInfo.Username, ProfileImage: userInfo.ProfileImage})
}
